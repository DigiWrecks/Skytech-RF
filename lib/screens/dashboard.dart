...
class _DashBoardState extends State<DashBoard> {
  ...
  getStayTunedIn() async {
    ...
    nextLogoutTime = DateFormat('HH:mm a')
        .format(loginTime.add(Duration(minutes: 480 * index)));
      ...
      logOut() async {
        ...
        if (distance < 123) {
          ...
          ToastBar(
                  color: Colors.red,
                  text:
                      'You must within the range of 350ft from your logged in location!')
              .show();
        }
      }
