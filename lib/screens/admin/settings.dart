      ...
      builder: (BuildContext context) {
        return StatefulBuilder(builder: (context, StateSetter setState) {
          return AlertDialog(
            ...
            title: CustomText(
              text: type == 'insert' ? 'Add new Location' : 'Update Location',
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Button(
                          text: type == 'insert' ? 'Add' : 'Update',
                          color: Colors.red,
                          onclick: () async {
                            if (newLocation.text.isNotEmpty &&
                                latController.text.isNotEmpty &&
                                longController.text.isNotEmpty &&
                                budgetedHoursControllers.text.isNotEmpty &&
                                date != 'Pick the Due Date') {
                              if (type == 'insert') {
                                locationList.add(newLocation.text);
                                await FirebaseFirestore.instance
                                    .collection('admin')
                                    .doc(widget.email)
                                    .update({'sites': locationList});
                                await FirebaseFirestore.instance
                                    .collection('admin')
                                    .doc(widget.email)
                                    .collection('sites')
                                    .doc(newLocation.text)
                                    .set({
                                  'site': newLocation.text,
                                  'lat': double.parse(latController.text),
                                  'long': double.parse(longController.text),
                                  'budgeted':
                                      int.parse(budgetedHoursControllers.text) *
                                          60,
                                  'dueDate': date,
                                  'total': 0
                                });
              ...
              child: workSitesList != null
                  ? ListView.builder(
                      ...
                      itemBuilder: (context, i) {
                        ...
                        String hours =
                            durationToString(workSitesList[i]['total']);
                        ...
                        String budgeted =
                            durationToString(workSitesList[i]['budgeted']);
